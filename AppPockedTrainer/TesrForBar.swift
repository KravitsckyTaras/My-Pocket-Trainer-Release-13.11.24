...
let buttons = [
    SliderButton(
        ...
        videoURL: URL(string: "https://www.youtube.com/embed/zBQaO3qlBQI?si=OWpLs0_Q_fYfMVhJ"),
        previewImageName: "35",
    ...
    SliderButton(
        ...
        videoURL: URL(string: "https://drive.google.com/file/d/1pEkaoUT-0U92izhveuxofQgKGUYQ9Y_n/view?usp=drive_link"), // Прямой URL видеофайла
